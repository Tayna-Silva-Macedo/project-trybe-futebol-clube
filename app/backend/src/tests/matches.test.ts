...
import { findTeamByIdMock } from './mocks/teams.mock';
...
describe('Testes da rota /matches', () => {
  describe('Verifica se retorna todas as partidas corretamente', () => {
    ...
    before(async () => {
      sinon.stub(Matches, 'findAll').resolves(findAllMatchesWithTeamNameMock as Matches[]);
  ...
  describe('Verifica se é possível filtrar as partidas em andamento', () => {
    ...
    it('retorna todas as partidas em andamento', () => {
      expect(response.body).to.be.deep.equal(findAllMatchesInProgressWithTeamNameMock);
    });
  });
  ...
  describe('Verifica se é possível filtrar as partidas finalizadas', () => {
    ...
    before(async () => {
      sinon.stub(Matches, 'findAll').resolves(findAllMatchesFinishedWithTeamNameMock as Matches[]);
    ...
    it('retorna todas as partidas finalizadas', () => {
      expect(response.body).to.be.deep.equal(findAllMatchesFinishedWithTeamNameMock);
    });
  });
